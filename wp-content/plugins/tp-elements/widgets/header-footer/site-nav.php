...
class Themephi_Navigation_Menu extends Widget_Base {
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units'         => [ 'px', 'em', '%' ],
					'selectors'          => [
						'{{WRAPPER}} .offcanvas-icon.layout-1 li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);

			$this->add_control(
				'res_menu_padding_border_radius',
				[
					'label' => esc_html__( 'Border Radius', 'tp-elements' ),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%' ],
					'selectors' => [
						'{{WRAPPER}} .offcanvas-icon.layout-1 li a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->start_controls_tabs( '_menu_text_style' );
				...
				$this->add_control(
					...
					[
						...
						'default'   => '',
						'selectors' => [
							'{{WRAPPER}} .sidenav .widget_nav_menu ul li a' => 'color: {{VALUE}};',
						],
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'default'   => '',
						'selectors' => [
							'{{WRAPPER}} #mobile_menu .submenu-button' => 'background: {{VALUE}};',
							'{{WRAPPER}} .menu-wrap-off .inner-offcan .nav-link-container .close-button' => 'background: {{VALUE}};',
							'{{WRAPPER}} .offcanvas-icon.layout-1 li a, {{WRAPPER}} .offcanvas-icon .nav-link-container .nav-menu-link svg' => 'background: {{VALUE}};'
						],
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'default'   => '',
						'selectors' => [
							'{{WRAPPER}} #mobile_menu .submenu-button:after' => 'color: {{VALUE}};',
							'{{WRAPPER}} .menu-wrap-off .inner-offcan .nav-link-container .close-button' => 'color: {{VALUE}};',
							'{{WRAPPER}} .offcanvas-icon .nav-link-container .nav-menu-link svg rect' => 'fill: {{VALUE}};',
						],
				...
				$this->add_control(
					'sticky_menu_icon_responsive',
					[
						'label'     => __( 'Sticky Responsive Menu Icon Color', 'tp-elements' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
							'.tp-sticky {{WRAPPER}} #mobile_menu .submenu-button:after' => 'color: {{VALUE}};',
							'.tp-sticky {{WRAPPER}} .menu-wrap-off .inner-offcan .nav-link-container .close-button' => 'color: {{VALUE}};',
							'.tp-sticky {{WRAPPER}} .offcanvas-icon .nav-link-container .nav-menu-link svg rect' => 'fill: {{VALUE}} !important;',
						],
				...
				$this->add_group_control(
					...
					[
						...
						'selector' => '{{WRAPPER}} .offcanvas-icon.layout-1 li a',
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type'      => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .sidenav .widget_nav_menu ul li a:hover' => 'color: {{VALUE}};',
						],
					]
				);	
							
				$this->add_control(
					'menu_icon_bg_hover_responsive',
					[
						'label'     => __( 'Responsive Menu Icon Bg', 'tp-elements' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
							'{{WRAPPER}} #mobile_menu .submenu-button:hover' => 'background: {{VALUE}};',
							'{{WRAPPER}} .menu-wrap-off .inner-offcan .nav-link-container .close-button:hover' => 'background: {{VALUE}};',
							'{{WRAPPER}} .offcanvas-icon.layout-1 li a:hover, {{WRAPPER}} .offcanvas-icon .nav-link-container .nav-menu-link:hover svg' => 'background: {{VALUE}};'
						],
					]
				);
				
				$this->add_control(
					'menu_icon_responsive_color_hover',
					[
						'label'     => __( 'Responsive Menu Icon Color', 'tp-elements' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
							'{{WRAPPER}} #mobile_menu .submenu-button:hover::after' => 'color: {{VALUE}};',
							' {{WRAPPER}} .menu-wrap-off .inner-offcan .nav-link-container .close-button:hover' => 'color: {{VALUE}};',
							'{{WRAPPER}} .offcanvas-icon .nav-link-container .nav-menu-link svg rect' => 'fill: {{VALUE}};',
						],
				...
				$this->add_control(
					'sticky_menu_icon_responsive_color_hover',
					[
						'label'     => __( 'Sticky Responsive Menu Icon Hover Color', 'tp-elements' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
							'.tp-sticky {{WRAPPER}} #mobile_menu .submenu-button:hover::after' => 'color: {{VALUE}};',
							'.tp-sticky {{WRAPPER}} .menu-wrap-off .inner-offcan .nav-link-container .close-button:hover' => 'color: {{VALUE}};',
							'.tp-sticky {{WRAPPER}} .offcanvas-icon .nav-link-container .nav-menu-link svg rect' => 'fill: {{VALUE}} !important;',
						],
				...
				$this->add_group_control(
					Group_Control_Border::get_type(),
					[
						'name'     => 'responsive_menu_icon_border_hover',
						'label'    => __( 'Border', 'tp-elements' ),
						'selector' => '{{WRAPPER}} .offcanvas-icon.layout-1 li a:hover',
					]
				);
	...
	<div class="menu-area <?php echo esc_attr($settings['layout'].$class_click_expand);?> separator_<?php echo esc_attr( $settings['seperator_on_click']);?> <?php echo esc_attr($class_responsvie_icon); ?>">         
		...
		<?php if( $settings['enable_responsive_icon'] == 'yes' ) : ?>
				...
				<li class="nav-link-container center"> 
					<a href="#" class="nav-menu-link menu-button">
						<svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<rect y="7" width="18" height="2" fill="currentColor"></rect>
