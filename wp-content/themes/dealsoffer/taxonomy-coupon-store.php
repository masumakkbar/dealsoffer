                    ...
                    <div class="coupon-box-layout-wrapper mb-40">
                        ...
                        <div class="coupon-box-layout-item coupon-box-layout-category">
                            ...
                            <div class="coupon-box-layout-item-content">
                                <h4 class="coupon-box-layout-item-number mb-10"><?php echo esc_html( $store_name ); ?></h4>

                                    <?php if (!empty($store_address)) : ?>
                                    <div class="store-address mb-10">
                                    ...
                                    <?php endif; ?>
                                <p class="coupon-box-layout-item-text"><?php echo wp_kses_post( $store_description ); ?></p>

                                <div class="store-go-to-website mt-25">
