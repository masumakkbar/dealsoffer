...
class Themephi_Elementor_Coupon_Store_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'TP Coupons Store', 'tp-elements' );
	}
	 ...
	 */
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'example 4', 'tp-elements' ),
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .themephi-addon-coupons .tp-coupon-info-list' => 'justify-content: {{VALUE}} !important',
                ],
				'separator' => 'before',
            ]
        );
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .themephi-addon-coupons .tp-coupon-button .tp-store-button.icon-before i' => 'margin-right: {{SIZE}}{{UNIT}};',
		            '{{WRAPPER}} .themephi-addon-coupons .tp-coupon-button .tp-store-button.icon-after i' => 'margin-left: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .themephi-addon-coupons .tp-store-button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        'name' => 'btn_typography',
		        'selector' => '{{WRAPPER}} .themephi-addon-coupons .tp-store-button',
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        'name' => 'button_border',
		        'selector' => '{{WRAPPER}} .tp-store-button',
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .themephi-addon-coupons .tp-store-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '',
		        'selectors' => [
		            '{{WRAPPER}} .themephi-addon-coupons .tp-coupon-button .tp-store-button' => 'color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .themephi-addon-coupons .tp-coupon-button .tp-store-button' => 'background-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .themephi-addon-coupons .tp-store-button.icon-before i' => '-webkit-transform: translateX(calc(-1 * {{SIZE}}{{UNIT}})); transform: translateX(calc(-1 * {{SIZE}}{{UNIT}}));',
		            '{{WRAPPER}} .themephi-addon-coupons .tp-store-button.icon-after i' => '-webkit-transform: translateX({{SIZE}}{{UNIT}}); transform: translateX({{SIZE}}{{UNIT}});',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .elementor-widget-container .themephi-addon-coupons .tp-store-button:hover, {{WRAPPER}} .elementor-widget-container .themephi-addon-coupons:focus .tp-store-button' => 'color: {{VALUE}};',
		            '{{WRAPPER}} .themephi-addon-coupons .tp-coupon-button .tp-store-button:hover' => 'color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .elementor-widget-container .themephi-addon-coupons .tp-store-button:hover, {{WRAPPER}} .elementor-widget-container .themephi-addon-coupons .tp-coupon-button:focus .tp-store-button' => 'background-color: {{VALUE}};',
		            '{{WRAPPER}} .themephi-addon-coupons .tp-coupon-button .tp-store-button:hover, {{WRAPPER}} .themephi-addon-coupons .tp-coupon-button:focus .tp-store-button' => 'background: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .elementor-widget-container .themephi-addon-coupons:hover .tp-store-button, {{WRAPPER}} .elementor-widget-container .themephi-addon-coupons .tp-store-button:focus' => 'border-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .elementor-widget-container .themephi-addon-coupons:hover .tp-store-button.icon-before i' => '-webkit-transform: translateX(calc(-1 * {{SIZE}}{{UNIT}})); transform: translateX(calc(-1 * {{SIZE}}{{UNIT}}));',
		            '{{WRAPPER}} .elementor-widget-container .themephi-addon-coupons .tp-store-button.icon-after i' => '-webkit-transform: translateX({{SIZE}}{{UNIT}}); transform: translateX({{SIZE}}{{UNIT}});',
		        ],
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        ...
		        'selector' => '{{WRAPPER}} .themephi-addon-coupons .tp-store-button ,
		        {{WRAPPER}} .themephi-addon-coupons .tp-store-button ',
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .themephi-addon-coupons .tp-coupon-button .tp-store-button:hover ' => 'background: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .elementor-widget-container .themephi-addon-coupons .tp-store-button:hover , {{WRAPPER}} .elementor-widget-container .themephi-addon-coupons .tp-store-button:focus ' => 'border-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .themephi-addon-coupons .tp-store-button i' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        ...
		        'selector' => '{{WRAPPER}} .themephi-addon-coupons .tp-store-button i,
		        {{WRAPPER}} .themephi-addon-coupons .tp-store-button i',
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        ...
		        'selector' => '{{WRAPPER}} .tp-store-button i',
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .themephi-addon-coupons .tp-store-button i' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '',
		        'selectors' => [
		            '{{WRAPPER}} .themephi-addon-coupons .tp-coupon-button .tp-store-button i' => 'color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .themephi-addon-coupons .tp-coupon-button .tp-store-button i' => 'background-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .elementor-widget-container .themephi-addon-coupons .tp-store-button:focus i' => 'color: {{VALUE}};',
		            '{{WRAPPER}}  .themephi-addon-coupons .tp-coupon-button .tp-store-button:hover i' => 'color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .elementor-widget-container .themephi-addon-coupons .tp-coupon-button:focus .tp-store-button:hover i' => 'background-color: {{VALUE}};',
		            '{{WRAPPER}} .themephi-addon-coupons .tp-coupon-button .tp-store-button:hover i' => 'background: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .elementor-widget-container .themephi-addon-coupons .tp-store-button:hover i, {{WRAPPER}} .elementor-widget-container .themephi-addon-coupons .tp-store-button:focus i' => 'border-color: {{VALUE}};',
		        ],
		    ]
		);
	...
	protected function render() {
		...
		$sstyle = $settings['coupon_style'];
			...
			<div class="tp-coupons-wrapper coupons-wrapper-<?php echo esc_attr( $settings['coupon_style'] ); ?> position-relative ">
                ...
                <?php endif; ?>
					...
					<?php
					$selected_stores = $settings['coupon_store'];

                    $stores_per_page = !empty($settings['per_page']) ? intval($settings['per_page']) : 4;
                    $paged = isset($_GET['paged']) ? max(1, intval($_GET['paged'])) : 1;
                    $offset = ($paged - 1) * $stores_per_page;

                    $args = [
                        'taxonomy' => 'coupon-store',
                        'hide_empty' => false,
                        'number' => $stores_per_page,
                        'offset' => $offset,
                    ...
                    if (!empty($selected_stores)) {
                        $args['slug'] = $selected_stores;
                    }
                    $stores = get_terms($args);
                    $total_stores = wp_count_terms('store', ['taxonomy' => 'coupon-store', 'hide_empty' => false]);
		...
		<?php 
			...
			$admin_tp_url = admin_url('term.php?taxonomy=coupon-store&post_type=coupon');
			echo '<div class="text-center"><a href=" '. $admin_tp_url .' " class="btn btn-danger">Create Coupon Store & Add to Coupon Post</a></div>';
		}
	}
