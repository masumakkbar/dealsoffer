        ...
        <div class="main-listing">
            <div class="row">
                            ...
                            <div class="widget white-block store-info ">
                                ...
                                <div class="white-block-content search-filter ">
                                    ...
                                    <div class="widget-title">
                                        <h4 class="mb-0">
                                            <?php printf( esc_html__( 'Deal or %s', 'dealsoffer' ), esc_html( ucfirst( $coupon_slug ) ) ); ?>
                                        </h4>
                                    </div>
                                ...
                                <div class="coupon-box-layout-wrapper mt-40">
                                    <div class="widget-title">
                                        <h4 class="mb-0">
                                            <?php printf( esc_html__( '%s Status', 'dealsoffer' ), esc_html( ucfirst( $coupon_slug ) ) ); ?>
                                        </h4>
                                    </div>
                                    <div class="coupon-box-layout-item mb-20">
                                        ...
                                        <div class="coupon-box-layout-item-content">
                                            <span class="coupon-box-layout-item-text"><?php printf( esc_html__( 'Total %s', 'dealsoffer' ), esc_html( ucfirst( $coupon_slug ) ) ); ?></span>
                                    ...
                                    <div class="coupon-box-layout-item mb-20">
                                        ...
                                        <div class="coupon-box-layout-item-content">
                                            <span class="coupon-box-layout-item-text"><?php printf( esc_html__( 'Active %s', 'dealsoffer' ), esc_html( ucfirst( $coupon_slug ) ) ); ?></span>
                ...
                <div class="col-xxl-8 col-xl-8 col-lg-8">
                                    ...
                                    <div class="flex-left header-alike">
                                        ...
                                        echo esc_html__( 'Found', 'dealsoffer' ) . ' ' . $coupons->found_posts . ' ' . 
                                            ( $coupons->found_posts == 1 
                                                ? esc_html( $coupon_slug ) 
                                                : esc_html( $coupon_slug . 's' ) 
                                            );
                                        ?>
                                    </div>
                    ...
                    <?php if ($term) : ?>
                    <div class="coupon-box-layout-wrapper mb-40">

                    <div class="themephi-sideabr">
                        <div class="widget-title">
                            <h4 class="mb-0">Category Informations</h4>
                        </div>
                    </div>
                        <div class="coupon-box-layout-item coupon-box-layout-category">
                            <?php if ($cat_image_url) : ?>
                            <div class="coupon-box-layout-item-icon">
                                <img src="<?php echo esc_url($cat_image_url); ?>" alt="<?php echo esc_attr($cat_name); ?>">
                            </div>
                            <?php endif; ?>
                            <div class="coupon-box-layout-item-content">
                                <h4 class="coupon-box-layout-item-number"><?php echo esc_html( $cat_name ); ?></h4>
                                <p class="coupon-box-layout-item-text"><?php echo wp_kses_post( $cat_desc ); ?></p>
