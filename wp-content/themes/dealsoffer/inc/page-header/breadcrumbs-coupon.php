...
<div class="themephi-breadcrumbs porfolio-details coupon-details">
                ...
                <div class="row">               
                    <div class="col-lg-12">                
                        ...
                        <?php 
                            ...
                            if(!empty($dealsoffer_option['off_breadcrumb'])){
...
<?php }
elseif (!empty($dealsoffer_option['department_single_image']['url'])) {
    ?>
    <div class="breadcrumbs-single" style="background-image: url('<?php echo esc_url( $dealsoffer_option['department_single_image']['url'] );?>')">
